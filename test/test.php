...
assert('containsSwearing(array("text"=>"CUNT friend")) /* swear words detection shouldn\'t be case sensitivie */');
assert('containsSwearing(array("text"=>"c*u*n*t")) /* swear words should be detected also in broken words or C*L*E*V*E*R*L*Y composed words */');
